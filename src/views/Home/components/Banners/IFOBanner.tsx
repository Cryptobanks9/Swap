...
import { Text, Flex, Button, ArrowForwardIcon, Heading } from 'cbui-kit'
...
const StyledHeading = styled(Heading)`
  color: #ffffff;
  background: -webkit-linear-gradient(#ce9f2c 0%, #452a7a 100%);
  background-clip: text;
  -webkit-background-clip: text;
...
const Wrapper = styled.div`
  border-radius: 32px;
  width: 100%;
  background-image: linear-gradient(#ce9f2c, #452a7a);
