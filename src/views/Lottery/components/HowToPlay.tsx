...
import { Box, Flex, Text, Heading, useMatchBreakpoints, Link, Image } from 'cbui-kit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.swap.cryptobanks.biz/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.swap.cryptobanks.biz/products/lottery/lottery-guide">
              {t('how to play the CBC Swap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
