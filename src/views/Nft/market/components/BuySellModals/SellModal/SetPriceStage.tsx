...
import { Flex, Grid, Box, Text, Button, BinanceIcon, ErrorIcon, useTooltip } from 'cbui-kit'
    ...
    <>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WBNB. You can swap WBNB to BNB 1:1 for free with CBC Swap.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
